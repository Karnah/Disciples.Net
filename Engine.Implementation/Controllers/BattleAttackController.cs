...
namespace Engine.Implementation.Controllers
{
    public class BattleAttackController : IBattleAttackController
    {
            ...
            if (curUnitAnimation.FramesCount - curUnitAnimation.FrameIndex <= 12) {
                ...
                foreach (var targetUnit in _targetUnits) {
                    ...
                    if (isAttacking) {
                        ...
                        if (targetUnit.BattleUnitEffects.Any(e => e.EffectType == BattleUnitEffectType.Defend)) {
                            damage /= 2;
                        }
        ...
        public event EventHandler UnitActionBegin;
        ...
        private void NextTurn()
        {
            do {
                if (_turnOrder.TryDequeue(out var nextUnit) && nextUnit.Unit.IsDead == false) {
                    ...
                    foreach (var battleUnitEffect in CurrentUnitObject.BattleUnitEffects) {
                        --battleUnitEffect.RoundDuration;
                    }

                    CurrentUnitObject.BattleUnitEffects.RemoveWhere(e => e.RoundDuration == 0);
                    return;
                }
        ...
        public bool AttackUnit(BattleUnit targetUnitGameObject)
        {
            ...
            UnitActionBegin?.Invoke(this, EventArgs.Empty);
        ...
        public void Defend()
        {
            ...
            CurrentUnitObject.BattleUnitEffects.Add(new BattleUnitEffect(BattleUnitEffectType.Defend, 1));
            NextTurn();
